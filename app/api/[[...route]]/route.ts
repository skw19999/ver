...
// ဒီနေရာမှာ /api ပြန်ထားပေးရပါမယ် (Rewrites ကြောင့်ပါ)
...
app.post('/login', async (c) => {
  ...
  if (body.password === ACCESS_PASSWORD) {
    ...
    return c.redirect('/'); // Redirect to Root (Config will handle rewrite)
  }
...
app.post('/create', async (c) => {
    ...
    // Link ထုတ်ပေးတဲ့အခါ /api မပါအောင် Root URL အတိုင်းထုတ်ပေးမယ်
